                ...
                <div class="col-xs-12">
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-header">
                                <h5><font color="red"><#if svXsl??>&nbsp;${svXsl}&nbsp;的行事历账期已安排，不能修改优先级</#if></font></h5>
                                <h5><font color="red"><#if has??>共选择了&nbsp;${priorityListSelected?size}&nbsp;家店铺，其中&nbsp;${priorityListSelected?size-priorityList?size}&nbsp;家已提交过申请</#if></font></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-responsive">
                        <form method="post" name="modfiyPriority" action="/priority/submitSmApply">
